      ...
      >
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-700 py-3.5 px-4 rounded-xl font-semibold hover:bg-gray-100 active:scale-[0.98] disabled:opacity-60 transition-all shadow-sm"
          >
